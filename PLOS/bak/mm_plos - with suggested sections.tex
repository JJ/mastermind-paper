...
% ------------------------------------------------------------
\subsection*{The game of Mastermind}
\label{subsec:mm}

As mentioned in the introduction, a MasterMind problem instance is
...
Section \ref{sec:nsm} we will propose new methods and prove that they
...
%***CORREGIR ESTO:*** The rest of the paper is organized as follows: we lay out the terminology and explain the solutions to the game of Mastermind in
...
Our intention is proposing new exhaustive search methods by using the two main factors that we have proved have an influence in the performance of
...
analyzed in Section \ref{sec:analysis}
...
\ell=6$ space. We use the same instance of 5000 combinations as we previously did *** REVIEW IF THIS IS TRUE ***. This size was big enough to find some differences among methods, and small enough for being able to perform the whole
...
\subsection*{Studying the effect of a different starting combination on
...
We mentioned in Subsection \ref{subsec:k6} that the probability of finding
