...
% keep "logik" here, it's another term for the game - JJ
\end{keyword}
...
% Antonio - ¿almohadilla P completo? no lo había visto nunca... quizá se podría comentar brevemente qué quiere decir o qué implica eso.
% In English, please!!! Let's see if I understand it first.... - JJ
This makes the
...
% se dice que cómo se puntúan las combinaciones contribuye a encontrar la solución antes - JJ
...
% Tiene valor 0. Llega porque el número de elementos es 0. - JJ
% Otras cosillas:
...
% quizá podrías poner una leyenda dentro del gráfico con la
% descripción de las líneas
% Ya lo he cambiado en la última versión
%
\begin{figure}[!htb]
\centering
...
% Conclussions, to that section - JJ
